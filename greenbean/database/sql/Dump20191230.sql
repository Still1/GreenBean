...
INSERT INTO `t_book_user` VALUES (1,2,1,NULL),(2,1,2,10),(2,2,1,8),(3,2,2,10);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_book_translator` AS select `t_book_translator`.`book_id` AS `book_id`,`t_translator`.`name` AS `translator_name` from ((`t_book_translator` join `t_book` on((`t_book_translator`.`book_id` = `t_book`.`id`))) join `t_translator` on((`t_book_translator`.`translator_id` = `t_translator`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-12-30 19:19:48

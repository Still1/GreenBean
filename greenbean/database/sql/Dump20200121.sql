...
INSERT INTO `t_book_user` VALUES (1,1,2,10,'2020-01-18 11:03:50','获益良多，准备去做心理咨询师了！！'),(1,2,1,4,'2020-01-16 22:35:49','读了第一章，内容太宽泛了，先给两星'),(1,4,2,NULL,'2020-01-18 10:59:01','这本书太厚了，读不下去！'),(1,6,2,10,'2020-01-18 11:06:59','很不错，对我在购物中与商家讨价还价很有用'),(1,7,2,10,'2020-01-18 11:09:29','不知道给两星的人是几个意思，估计是自己智障理解不了吧'),(1,8,2,8,'2020-01-18 11:13:09','还行，上大学本科时候的教材用书'),(2,1,2,10,'2020-01-10 13:24:31',NULL),(2,2,1,8,'2020-01-10 13:24:31',NULL),(3,2,2,10,'2020-01-10 13:24:31',NULL),(30,2,2,8,'2020-01-17 14:52:02','good'),(31,2,1,4,'2020-01-15 09:28:32',NULL),(32,2,1,8,'2020-01-15 10:22:08',NULL),(35,2,2,8,'2020-01-15 10:25:26',NULL);
...
INSERT INTO `t_user` VALUES (1,'clio','$2a$10$OaExo/3Us/rhx/zJais8..HbFSI6S35BWswLswHdvjrwUN4oWIm5W',1,'Clio','43826406-101b-4e68-9ee6-d36276e192b1.jpg'),(2,'c','$2a$10$.Pkblm5dhEnB1Hm6SJOhneQz6CJwSZLORZxY44gkumUHUBwmwCruS',1,'电鳗ss','36070720-ffe9-49ac-9b45-c5e06912e9f3.jpg'),(4,'a','$2a$10$ywvEmJFiwT3.xDp0CgejbuYze5vKRSjto8HINydBA/azTQ8Q7mYcO',1,'哆啦A梦','b663ccad-adec-4df6-b111-87ba872ab318.png'),(6,'e','$2a$10$aO.fD.zThGfmc562Aps6k..kP0aT3/4Hkn561ZvggT1viFL8hjDgW',1,'杜如风',NULL),(7,'f','$2a$10$MyYgfby34w11jDWXtpRdqOpbEhsohfV6uG2KzNkJ9kH2pnwgjVqrS',1,'厕所修理工','63719b0a-e2d1-4637-86c8-0bb3b1b31714.png'),(8,'h','$2a$10$KcXrKzfnc1kMBce34iYVZ.7yrUATCPQOBMHCC.Ci4oPU/5pvVNOWq',1,'Donleo','76f095dd-1503-476a-bb49-7d0315cdfef0.png'),(9,'j','$2a$10$M6Ob2G2q9D4AT7ULrAoiROTaH2kHJP3ODStjRcWEQR8j0gYF1TZg.',1,'j','5cb491db-33d5-4c1a-83df-1273ab2d86db.png');
...
--
-- Temporary view structure for view `v_book_comment`
--

DROP TABLE IF EXISTS `v_book_comment`;
/*!50001 DROP VIEW IF EXISTS `v_book_comment`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `v_book_comment` AS SELECT 
 1 AS `book_id`,
 1 AS `nickname`,
 1 AS `score`,
 1 AS `time`,
...
--
-- Temporary view structure for view `v_book_read`
--

DROP TABLE IF EXISTS `v_book_read`;
/*!50001 DROP VIEW IF EXISTS `v_book_read`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `v_book_read` AS SELECT 
 1 AS `nickname`,
 1 AS `avatar`,
 1 AS `book_id`,
 1 AS `time`,
...
--
-- Final view structure for view `v_book_comment`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_book_comment` AS select `t_book_user`.`book_id` AS `book_id`,`t_user`.`nickname` AS `nickname`,`t_book_user`.`score` AS `score`,`t_book_user`.`time` AS `time`,`t_book_user`.`comment` AS `comment` from (`t_book_user` join `t_user` on((`t_user`.`id` = `t_book_user`.`user_id`))) where ((`t_book_user`.`comment` is not null) and (`t_book_user`.`comment` <> '')) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_book_read`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_book_read` AS select `t_user`.`nickname` AS `nickname`,`t_user`.`avatar` AS `avatar`,`t_book_user`.`book_id` AS `book_id`,`t_book_user`.`time` AS `time`,`t_book_user`.`type` AS `type` from (`t_book_user` join `t_user` on((`t_user`.`id` = `t_book_user`.`user_id`))) order by `t_book_user`.`time` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-01-21 20:09:36
